...
// $conn->sql->attach("Update","Update bookevent set event_name='{event_name}',start_date='{start_date}',end_date='{end_date}',rec_type='{rec_type}',event_pid='{event_pid}',event_length='{event_length}',event_location='{event_location}',lat='{lat}',lng='{lng}',readonly='{readonly}',priority='{priority}',Privacy='{Privacy}',c_id='{c_id}',priority='{priority}' where event_id={event_id}");

// $conn->sql->attach("Delete","DELETE FROM bookevent WHERE event_id={event_id}");

// $conn->sql->attach("Insert","INSERT INTO `calendar`.`bookevent` (`event_id`, `event_name`, `start_date`, `end_date`, `event_length`, `event_pid`, `rec_type`, `details`, `event_location`, `lat`, `lng`, `c_id`, `readonly`, `priority`, `Privacy`) 
