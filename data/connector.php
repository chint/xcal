...
$conn->render_sql("select * from events where c_id = ".$c_id ,"event_id","start_date,end_date,event_name,rec_type,event_pid,event_length,details,event_location,lat,lng,readonly,priority");
